...
type ContactServiceClient interface {
	GetContacts(ctx context.Context, in *All, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Contacts], error)
	AddContact(ctx context.Context, in *Contact, opts ...grpc.CallOption) (*Contact, error)
}
...
func (c *contactServiceClient) GetContacts(ctx context.Context, in *All, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Contacts], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ContactService_ServiceDesc.Streams[0], ContactService_GetContacts_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[All, Contacts]{ClientStream: stream}
...
type ContactService_GetContactsClient = grpc.ServerStreamingClient[Contacts]

func (c *contactServiceClient) AddContact(ctx context.Context, in *Contact, opts ...grpc.CallOption) (*Contact, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Contact)
...
type ContactServiceServer interface {
	GetContacts(*All, grpc.ServerStreamingServer[Contacts]) error
	AddContact(context.Context, *Contact) (*Contact, error)
...
func (UnimplementedContactServiceServer) GetContacts(*All, grpc.ServerStreamingServer[Contacts]) error {
	return status.Errorf(codes.Unimplemented, "method GetContacts not implemented")
}
func (UnimplementedContactServiceServer) AddContact(context.Context, *Contact) (*Contact, error) {
...
func _ContactService_GetContacts_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(All)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ContactServiceServer).GetContacts(m, &grpc.GenericServerStream[All, Contacts]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ContactService_GetContactsServer = grpc.ServerStreamingServer[Contacts]
...
func _ContactService_AddContact_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContactServiceServer).AddContact(ctx, req.(*Contact))
	}
